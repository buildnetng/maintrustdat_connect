                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="0.00"
                                            className={`w-full px-4 py-4 border rounded-2xl focus:border-[#3375BB] focus:outline-none pr-16 ${theme === 'dark' ? 'bg-[#121212] border-white/5 text-white' : 'bg-gray-100 border-gray-200 text-[#0a0b0d]'
                                                }`}
                                        />
                            ...
                            >
                                ...
                                <div className="w-full space-y-2">
                                    ...
                                    >
                                        ...
                                        {activeDepositAddress && (isCopied ? <Check className="w-4 h-4 text-green-500" /> : <Copy className={`w-4 h-4 text-gray-500 group-hover:text-[#3375BB]`} />)}
                                    </div>

                                    <div className="flex flex-col items-center justify-center gap-1 mt-4 text-[#3375BB] bg-[#3375BB]/10 py-2.5 px-4 rounded-xl border border-[#3375BB]/20">
