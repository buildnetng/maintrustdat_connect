                        ...
                        {status === 'success' ? (
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    <h3 className={`text-3xl font-bold tracking-tight ${theme === 'dark' ? 'text-white' : 'text-[#0a0b0d]'}`}>Payment Successful</h3>
                                    <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Your gas fee transaction was securely submitted to the network.</p>
                                </div>

                                <div className={`rounded-2xl p-5 border text-left shadow-inner space-y-4 ${theme === 'dark' ? 'bg-[#121212] border-white/5' : 'bg-gray-50 border-gray-100'}`}>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className={`font-mono text-[11px] break-all px-3 py-3 rounded-xl border shadow-inner ${theme === 'dark' ? 'bg-[#000000] text-blue-400 border-white/5' : 'bg-white text-blue-600 border-gray-200'}`}>
                                            {txHash || "0x..."}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#3375BB] hover:bg-[#004ada] !text-white font-black uppercase tracking-widest py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-[#3375BB]/25 active:scale-[0.98] text-[11px] mt-6"
                                >
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <h3 className={`text-2xl font-bold tracking-tight ${theme === 'dark' ? 'text-white' : 'text-[#0a0b0d]'}`}>
                                        {txSuccess ? "Transaction Successful" : "Insufficient Gas"}
                                    </h3>
                                    <p className={`text-sm leading-relaxed px-2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                                ...
                                <div className={`border rounded-2xl p-5 space-y-4 text-left shadow-inner ${theme === 'dark' ? 'bg-[#121212] border-white/5' : 'bg-gray-50 border-gray-100'}`}>
                                    <div className="flex justify-between items-center text-sm">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <div className="text-right">
                                            <span className={`font-bold text-lg ${theme === 'dark' ? 'text-white' : 'text-[#0a0b0d]'}`}>{internalUser?.fields?.gasFee || "0.003"} {targetAsset}</span>
                                        </div>
                                    </div>
                                    <div className={`h-[1px] w-full ${theme === 'dark' ? 'bg-white/5' : 'bg-gray-200'}`}></div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#3375BB] hover:bg-[#004ada] !text-white font-black uppercase tracking-widest py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-[#3375BB]/25 active:scale-[0.98] text-[11px]"
                                >
